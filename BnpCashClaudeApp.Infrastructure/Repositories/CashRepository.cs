...
{
    /// <summary>
    /// Repository برای Entity های Cash Database
    /// ============================================
    /// این Repository از CashDbContext استفاده می‌کند
    /// برای Entity های: tblSarfasl, tblSarfaslType, tblSarfaslProtocol, tblCombo
    /// ============================================
    /// </summary>
    public class CashRepository<T> : IRepository<T> where T : BaseEntity
    {
        protected readonly CashDbContext _context;
        protected readonly DbSet<T> _dbSet;

        public CashRepository(CashDbContext context)
        {
            _context = context;
