...
{
    /// <summary>
    /// اعتبارسنجی فرمان ویرایش نوع تفصیلی
    /// </summary>
    public class UpdateTafsiliTypeCommandValidator : AbstractValidator<UpdateTafsiliTypeCommand>
    {
        public UpdateTafsiliTypeCommandValidator()
        {
